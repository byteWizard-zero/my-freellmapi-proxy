...
[![CI](https://github.com/1bitVscoder/my-freellmapi-proxy/actions/workflows/ci.yml/badge.svg)](https://github.com/1bitVscoder/my-freellmapi-proxy/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/1bitVscoder/my-freellmapi-proxy.git
cd freellmapi
npm install
